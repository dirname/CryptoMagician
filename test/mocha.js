...
describe("Scrypt Node Module Tests", function () {
    describe("Scrypt Params Function", function () {
        ...
        describe("Synchronous functionality with incorrect arguments", function () {
            ...
            it("Will throw a TypeError if any arguments are not numbers", function () {
                ...
                for (var i = 0; i < args.length; i++) {
                    ...
                    args[i] = "not a number";
                    expect(function () {
                        scrypt.paramsSync(args[0], args[1], args[2]);
                    })
                        .to.throw(TypeError)
        ...
        describe("Asynchronous functionality with incorrect arguments", function () {
            ...
            it("Will throw a RangeError exception if max_memfrac is not between 0.0 and 1.0", function () {
                expect(function () {
                    scrypt.params(1, 2, -0.1, function () {
                    });
                })
                    .to.throw(RangeError)
                    .to.match(/^RangeError: max_memfrac must be between 0.0 and 1.0 inclusive$/);
                ...
                expect(function () {
                    scrypt.params(1, 2, 1.1, function () {
                    });
                })
                    .to.throw(RangeError)
                    .to.match(/^RangeError: max_memfrac must be between 0.0 and 1.0 inclusive$/);
            ...
            it("Will throw a TypeError if any arguments are not numbers", function () {
                ...
                for (var i = 0; i < args.length; i++) {
                    ...
                    args[i] = "not a number";
                    expect(function () {
                        scrypt.params(args[0], args[1], args[2], function () {
                        });
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: (maxtime|maxmem|max_memfrac) must be a number$/);
    ...
    describe("Scrypt KDF Function", function () {
        describe("Synchronous functionality with incorrect arguments", function () {
            ...
            it("Will throw a TypeError if the key is not a string or a Buffer object", function () {
                expect(function () {
                    scrypt.kdfSync(1123, {N: 1, r: 1, p: 1})
                })
                    .to.throw(TypeError)
            ...
            it("Will throw a TypeError if the Scrypt params object is incorrect", function () {
                expect(function () {
                    scrypt.kdfSync("password", {N: 1, p: 1})
                })
                    .to.throw(TypeError)
        ...
        describe("Asynchronous functionality with incorrect arguments", function () {
            ...
            it("Will throw a SyntaxError if no callback function is present", function () {
                expect(function () {
                    scrypt.kdf(new Buffer("password"), {N: 1, r: 1, p: 1});
                })
                    .to.throw(SyntaxError)
                    .to.match(/^SyntaxError: No callback function present, and Promises are not available$/);
            })
            ...
            it("Will throw a TypeError if the Scrypt params object is incorrect", function () {
                expect(function () {
                    scrypt.kdf("password", {N: 1, r: 1}, function () {
                    })
                })
                    .to.throw(TypeError)
    ...
    describe("Scrypt Hash Function", function () {
        describe("Create Hash", function () {
            describe("Synchronous functionality with incorrect arguments", function () {
                ...
                it("Will throw a TypeError if the key is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.hashSync(1123, {N: 1, r: 1, p: 1}, 32, "NaCl")
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Key type is incorrect: It can only be of type string or Buffer$/);
                })
                ...
                it("Will throw a TypeError if the Scrypt params object is incorrect", function () {
                    expect(function () {
                        scrypt.hashSync("hash something", {N: 1, r: 1}, 32, "NaCl")
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Scrypt params object does not have 'p' property present$/);
                })
                ...
                it("Will throw a TypeError if the hash length is not an integer", function () {
                    expect(function () {
                        scrypt.hashSync("hash something", {N: 1, r: 1, p: 1}, 32.5, new Buffer("NaCl"))
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Hash length must be an integer$/);

                    expect(function () {
                        scrypt.hashSync("hash something", {N: 1, r: 1, p: 1}, "thirty-two", "NaCl")
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Hash length must be an integer$/);
                })
                ...
                it("Will throw a TypeError if the salt is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.hashSync("hash something", {N: 1, r: 1, p: 1}, 32, 45)
                    })
                        .to.throw(TypeError)
            ...
            describe("Asynchronous functionality with incorrect arguments", function () {
                ...
                it("Will throw a SyntaxError if no callback function is present", function () {
                    expect(function () {
                        scrypt.hash("hash something", {N: 16, r: 1, p: 1}, 64, "NaCl");
                    })
                        .to.throw(SyntaxError)
                        .to.match(/^SyntaxError: No callback function present, and Promises are not available$/);
                })
                ...
                it("Will throw a TypeError if the key is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.hash(1123, {N: 16, r: 1, p: 1}, 32, "NaCl", function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Key type is incorrect: It can only be of type string or Buffer$/);
                ...
                it("Will throw a TypeError if the Scrypt params object is incorrect", function () {
                    expect(function () {
                        scrypt.hash("hash something", {N: 16, r: 1}, 32, "NaCl", function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Scrypt params object does not have 'p' property present$/);
                ...
                it("Will throw a TypeError if the hash length is not an integer", function () {
                    expect(function () {
                        scrypt.hash("hash something", {N: 16, r: 1, p: 1}, 32.5, new Buffer("NaCl"), function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Hash length must be an integer$/);
                    ...
                    expect(function () {
                        scrypt.hash("hash something", {N: 16, r: 1, p: 1}, "thirty-two", "NaCl", function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Hash length must be an integer$/);
                ...
                it("Will throw a TypeError if the salt is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.hash("hash something", {N: 16, r: 1, p: 1}, 32, 45, function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Salt type is incorrect: It can only be of type string or Buffer$/);
        ...
        describe("Verify Hash", function () {
            ...
            describe("Asynchronous functionality with incorrect arguments", function () {
                ...
                it("Will throw a TypeError if the KDF is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.verifyKdf(1232, "key", function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: KDF type is incorrect: It can only be of type string or Buffer$/);
                ...
                it("Will throw a TypeError if the key is not a string or a Buffer object", function () {
                    expect(function () {
                        scrypt.verifyKdfSync("KDF", 1232, function () {
                        })
                    })
                        .to.throw(TypeError)
                        .to.match(/^TypeError: Key type is incorrect: It can only be of type string or Buffer$/);
                ...
                it("Will throw an Error if KDF buffer is not a valid scrypt-encrypted block", function () {
                    expect(function () {
                        scrypt.verifyKdfSync("KDF", "key", function () {
                        })
                    })
                        .to.throw(Error)
                        .to.match(/^Error: data is not a valid scrypt-encrypted block$/);
